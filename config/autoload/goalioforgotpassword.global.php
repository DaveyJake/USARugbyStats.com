...
$settings = array(
    ...
    'email_from_address' => array(
        'email' => 'noreply@usarugbystats.com',
        'name' => 'USARugbyStats.com',
    ),
     ...
     */
    'reset_email_subject_line' => '[USARugbyStats] Your request to reset your account password',
    ...
    'zfc_rbac' => [
        'guards' => [
            'ZfcRbac\Guard\RouteGuard' => [
                'zfcuser/forgotpassword' => [ 'guest' ],
                'zfcuser/resetpassword' => [ 'guest' ],
            ],
        ],
    ],
);
