...
class PlayerStatisticsServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testHandlesScoreProperly($type)
    {
        ...
        $expected['season']['2014-2015']['cumulative'] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['cumulative'][$type] = 1;
        $expected['season']['2014-2015']['cumulative']['PTS'] = $event->getPoints();
        $expected['season']['2014-2015']['team'][$homeTeam->getId()] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['team'][$homeTeam->getId()][$type] = 1;
        $expected['season']['2014-2015']['team'][$homeTeam->getId()]['PTS'] = $event->getPoints();
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()][$type] = 1;
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()]['PTS'] = $event->getPoints();
    ...
    public function testScoresAreAdded()
    {
        ...
        $expected['season']['2014-2015']['cumulative'] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['cumulative']['TR'] = 1;
        $expected['season']['2014-2015']['cumulative']['CV'] = 1;
        $expected['season']['2014-2015']['cumulative']['PTS'] = $totalPoints;
        $expected['season']['2014-2015']['team'][$homeTeam->getId()] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['team'][$homeTeam->getId()]['TR'] = 1;
        $expected['season']['2014-2015']['team'][$homeTeam->getId()]['CV'] = 1;
        $expected['season']['2014-2015']['team'][$homeTeam->getId()]['PTS'] = $totalPoints;
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()] = $this->getStatsFieldArray();
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()]['TR'] = 1;
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()]['CV'] = 1;
        $expected['season']['2014-2015']['opponent'][$awayTeam->getId()]['PTS'] = $totalPoints;
        $expected['team'][$homeTeam->getId()]['career'] = $this->getStatsFieldArray();
