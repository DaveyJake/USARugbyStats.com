...
class UnionServiceTest extends \PHPUnit_Framework_TestCase
{
    protected $service;
    ...
    public function setUp()
    {
        ...
        $this->service = new UnionService();
        $this->service->setUnionRepository($this->mockRepository);
        $this->service->setUnionObjectManager($this->mockObjectManager);
    ...
    public function testCreateMethod()
    {
        ...
        $service = Mockery::mock('UsaRugbyStats\Competition\Service\UnionService[save]');
        $service->shouldReceive('save')->once()->andReturnNull();

        // Inject the rest of the dependencies
        $service->setUnionRepository($this->mockRepository);
        $service->setUnionObjectManager($this->mockObjectManager);
