...
class TeamServiceTest extends \PHPUnit_Framework_TestCase
{
    protected $service;
    ...
    public function setUp()
    {
        ...
        $this->service->setTeamRepository($this->mockRepository);
        $this->service->setTeamObjectManager($this->mockObjectManager);
