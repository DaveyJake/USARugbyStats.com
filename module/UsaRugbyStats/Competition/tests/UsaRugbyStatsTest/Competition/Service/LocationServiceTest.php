...
class LocationServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->service->setLocationRepository($this->mockRepository);
        $this->service->setLocationObjectManager($this->mockObjectManager);
    ...
    public function testCreateMethod()
    {
        ...
        $service = Mockery::mock('UsaRugbyStats\Competition\Service\LocationService[save]');
        $service->shouldReceive('save')->once()->andReturnNull();

        // Inject the rest of the dependencies
        $service->setLocationRepository($this->mockRepository);
        $service->setLocationObjectManager($this->mockObjectManager);
