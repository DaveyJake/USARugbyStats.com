...
use Mockery;
use UsaRugbyStats\Competition\InputFilter\LocationFilterFactory;

class LocationFilterFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $factory = new LocationFilterFactory();
        $object = $factory->createService($this->serviceManager);
        $this->assertInstanceOf('UsaRugbyStats\Competition\InputFilter\LocationFilter', $object);
    }
}
